...
// 채팅 패널에 출려되는 HTML 태그 작성
// getHTML(String adminMEssage) 입장, 퇴장 메시지 출력
// getHTML(boolean isMine, Message message) 일반 메시지 / 이미지 출력
	...
	public String getHTML(boolean isMine, Message message) {
		...
		String htmlResult =
				...
				"				<div style=\"background-color: " + background.get(isMine) + "; padding: 5px;\">" +
									userMsg.getOrDefault(messageType, userMessage) + "<br>" + today +
				"				</div>" +
				"			</td>" +
				"    	</tr>" + 
				"	</table>" +
