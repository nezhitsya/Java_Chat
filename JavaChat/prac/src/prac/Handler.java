...
import prac.User;
import prac.DuplicateUsernameException;
import prac.NaverSearching;
import prac.UserList;
// 클라이언트에서 넘어온 message를 현재 접속 클라이언트들에게 송신
public class Handler implements Runnable {
	...
	private void addUser() throws IOException, DuplicateUsernameException, ClassNotFoundException {
		...
		if (UserList.addList(user)) {
			...
			sendDuplicateError();
			throw new DuplicateUsernameException("중복된 닉네임 입니다.");
		}
	}
